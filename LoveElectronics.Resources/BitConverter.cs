/***
 Bit Converter class from the Netduino forum.
***/
...
namespace LoveElectronics.Resources
{
    public static class BitConverter
    {
        ...
        public static unsafe byte[] GetBytes(params double[] data)
        {
            byte[] buffer = new byte[data.Length * 8];
            GetBytes(buffer, 0, data);
            return buffer;
        }

        public static unsafe void GetBytes(byte[] buffer, int offset, params double[] data)
        {
